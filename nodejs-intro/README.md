...
3. Start Insomnia software and create a new request (CTRL + N). Access localhost:8080/users and select a GET or POST method. When you run the request you will see the return from the server on the console.
